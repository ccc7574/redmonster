        ...
        <Content style={{ padding: 12}}>
          <View style={{backgroundColor: "#1A1A1A"}}>
            <View style={{flexDirection: "row", justifyContent: "space-between", alignItems: "center", padding: 10}}>
              ...
              <View style={{ width: "84%", paddingLeft: 10, paddingRight: 10}}>
                <View style={{flexDirection: "row", justifyContent: "space-between", marginBottom: 10}}>
                  <Text style={styles.fontWhite}>提货人：李四</Text>
                  <Text style={styles.fontWhite}>15098765432</Text>
                </View>
                <Text style={styles.fontWhite}>江苏省无锡市滨湖区蠡湖大道1800号江南大学南门24栋5号</Text>
              </View>
                ...
                <Right>
                  <Form>
                    <Picker
                      ...
                      onValueChange={this.onValueChange.bind(this)}
                    >
                      <Item label="顺丰速运" value="key0" />
                      <Item label="圆通快递" value="key1" />
                      <Item label="中通快递" value="key2" />
                      <Item label="申通快递" value="key3" />
                      <Item label="EMS邮政" value="key4" />
                    </Picker>
                  </Form>
                </Right>
              </View>
