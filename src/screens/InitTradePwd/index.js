...
class InitTradePwd extends Component {
  constructor(props) {
    super(props);
    this.state = {
      Msg: '',
    ...
    return (
      <Container style={{backgroundColor: '#fff'}}>
        ...
        <Content style={{marginTop: 60, marginLeft: 30, marginRight: 30,}}>
          <Text style={{marginTop: 60, marginLeft: 30, marginBottom: 5}}>请输入支付密码</Text>
          ...
          <Text style={{marginTop: 40, marginLeft: 30, marginBottom: 5}}>请再次输入支付密码</Text>
          <View style={styles.container}>
            <View style={{flexDirection:'row',marginTop :10,justifyContent:'center'}}>
              <TextInput
                style={styles.textInputMsg}
